...
<h1 class="h3 mb-2 text-gray-800">Historial de peticions Cancelades</h1>

<p class="mb-4"></a>Llista de les peticions cancelades.</p>

<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Peticions cancelades</h6>
    </div>
    <div class="card-body">
...
<script>
    $(document).ready(function () {
        var table = $('#ofertes').DataTable({
            ajax: {
                url: " {{ route('getDeletedStudentRequests') }}"
            },
            language: {
            ...
            columns: [
                ...
                { "targets": 5, "data": 'offer.company_type' },
                {
                    ...
                    "render": function (data, type, row, meta) {
                        return `
                            <a href="{{ url('admin/requestRestoreVisibility/${data}/${row.offer_id}') }}" onclick="return confirm('Segu que vols recuperar la oferta')" class="btn btn-success btn-circle"> <i class="fas fa-trash-restore"></i> </a>
                            <a href="{{ url('admin/moreInfoNoVisible/${data}/${row.offer_id}') }}" class="btn btn-info btn-circle"> <i class="fas fa-info-circle"></i> </a>              
                            `;
                    }
                }
            ],
