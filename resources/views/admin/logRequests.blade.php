            ...
            columns: [
                ...
                { "targets": 6, "data": 'offer.characteristics' },
                {
                    ...
                    "render": function (data, type, row, meta) {
                        return `
                            <a href="{{ url('admin/moreInfoNoVisible/${data}/${row.offer_id}') }}" class='btn btn-secondary'>Mes informacio</a> 
                            <a href="{{ url('admin/requestRestoreVisibility/${data}/${row.offer_id}') }}" onclick="return confirm('Segu que vols recuperar la peticio ')" class='btn btn-danger'>Recuperar</a> 
                            `;
                    }
                }
            ],
